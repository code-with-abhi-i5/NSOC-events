        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            <div className="flex items-center gap-2 ml-2">
              ...
              <Link
                to="/admin/login"
                className="inline-flex items-center gap-1.5 rounded-xl border border-border/80 bg-secondary/80 hover:bg-secondary px-3.5 py-2 text-xs font-semibold text-foreground transition-all hover:border-primary/40 shadow-sm"
              >
            ...
            >
              ...
              <div className="pt-2 border-t border-border/60 space-y-2">
                <Link
                  to="/admin/login"
                  onClick={() => setMobileOpen(false)}
                  className="flex items-center justify-between px-4 py-2.5 rounded-xl text-sm font-semibold text-primary bg-primary/5 hover:bg-primary/10 transition-colors"
                >
                  <span className="flex items-center gap-2">
